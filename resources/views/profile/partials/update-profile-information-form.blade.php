    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-6" enctype="multipart/form-data">
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-100">
            ...
            <div class="flex items-center space-x-6">
                ...
                @else
                    <div
                        class="w-24 h-24 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center border-4 border-white shadow-lg ring-2 ring-gray-100">
                ...
                <div class="flex-1">
                    <label for="avatar" class="relative cursor-pointer">
                        <div
                            class="flex items-center justify-center px-6 py-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#D98718] hover:bg-[#D98718]/5 transition-all duration-300 group">
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-[#D98718] transition-colors mr-2"
                            ...
                            <span
                                class="text-sm font-medium text-gray-600 group-hover:text-[#D98718] transition-colors">
                                Pilih Foto Baru
                            </span>
                        </div>
        ...
        <div>
            ...
            <input id="name" name="name" type="text"
                ...
                focus:ring-2 focus:ring-[#D98718] 
                focus:border-[#D98718] 
                focus:outline-none
        ...
        <div>
            <label for="email" class="block text-sm font-semibold text-gray-700 mb-2">
                <span class="flex items-center">
                    <svg class="w-4 h-4 mr-2 text-[#D98718]" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
