    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                <input id="update_password_current_password" 
                       ...
                       type="password" 
                       class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 text-gray-900" 
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-4">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h4 class="text-sm font-bold text-orange-900 mb-2">Tips Keamanan Password</h4>
                    <ul class="text-xs text-orange-800 space-y-1">
                        <li class="flex items-start">
                            <svg class="w-4 h-4 mr-1.5 mt-0.5 flex-shrink-0 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            <div class="flex items-center gap-3">
                <button type="submit"
                    class="inline-flex items-center px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 focus:ring-4 focus:ring-orange-500/20">
