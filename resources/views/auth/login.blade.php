...
<head>
    ...
    <title>Login - Warung Soto Vokasi</title>
...
<body
    ...
    <div
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Masuk untuk bisa memesan pesanan</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                <label class="block text-gray-700 font-semibold mb-2 ml-1 text-sm" for="email">EMAIL</label>
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email"
                        class="w-full pl-10 pr-4 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition bg-gray-50 text-gray-800 @error('email') border-red-500 ring-red-500/50 @enderror"
            ...
            <div>
                <label class="block text-gray-700 font-semibold mb-2 ml-1 text-sm" for="password">PASSWORD</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <input type="password" name="password" id="passwordInput"
                        class="w-full pl-10 pr-12 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition bg-gray-50 text-gray-800 @error('password') border-red-500 ring-red-500/50 @enderror"
            ...
            <div class="flex items-center justify-between">
                ...
                @if (Route::has('password.request'))
                    <a class="text-sm text-green-600 hover:text-green-800 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
        ...
        <div class="mt-8 pt-6 border-t border-gray-200 text-center">
            <p class="text-xs text-gray-400">© {{ date('Y') }} Warung Soto Vokasi. All rights reserved.</p>
        </div>
    </div>
